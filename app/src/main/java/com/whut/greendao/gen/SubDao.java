 ...
 * DAO for table "SUB".
*/
public class SubDao extends AbstractDao<Sub, Long> {
    ...
    public static class Properties {
        ...
        public final static Property Idd = new Property(2, String.class, "idd", false, "idd");
    }
    ...
    public Sub readEntity(Cursor cursor, int offset) {
        Sub entity = new Sub( //
            ...
            cursor.isNull(offset + 2) ? null : cursor.getString(offset + 2) // idd
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Sub entity, int offset) {
        ...
        entity.setIdd(cursor.isNull(offset + 2) ? null : cursor.getString(offset + 2));
     }
    
    @Override
    protected final Long updateKeyAfterInsert(Sub entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(Sub entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
