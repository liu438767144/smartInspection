...
public class ChargedDetectionActivity extends SwipeBackActivity {
...
//    EditText principalSignature;
    ...
    final static String TAG = "ChargedDetectionActivity";
...
//    private String[] devlist={"红外热成像检测","高压开关柜地电波检测","变压器（高抗）铁芯与夹件接地电流检测",
//            "接地装置接地引下线导通检测","声级检测(厂界噪声测试)"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_charged_detection);
        ...
        workTimeStart.setText(simpleDateFormat.format(date));
        CustomToolBar.goBack(ChargedDetectionActivity.this);//返回按钮监听
...
//        style.selectedTextZoom = 5L;
        if (SApplication.isPad(ChargedDetectionActivity.this)) {//平板
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.style_device:
                ...
                break;
            case R.id.btn_help:
                Intent intent = new Intent(ChargedDetectionActivity.this, WorkingHelpActivity.class);
            ...
            case R.id.toolbar_right_tv://提交任务 发送
                ...
                if (!ButtonUtils.isFastDoubleClick(R.id.btn_login_user_login)) {
                    ...
                    SimpleDateFormat simpleDateFormat = new SimpleDateFormat("yyyy-MM-dd HH:mm");// HH:mm:ss
                    Date date = new Date(System.currentTimeMillis());//获取当前时间
                    workTimeEnd.setText(simpleDateFormat.format(date));
                    ...
                    SystemUtils.showToast(ChargedDetectionActivity.this, "正在提交数据！");
...
//            list.add(devlist[i]);
//        }
////        dialog.setTitle("选择设备类型").setButtonText("确定").setDialogStyle(Color
//                .parseColor("#6699ff")).setCount(5).setOnDialogItemClickListener(new WheelViewDialog.OnDialogItemClickListener() {
//            @Override
//            public void onItemClick(int position, String s) {
//                int i = position;
